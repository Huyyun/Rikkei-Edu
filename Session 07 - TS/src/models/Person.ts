// Link đề: https://docs.google.com/document/d/1YQ5zGwn8Ug_YcTSq_6KkOzgD2fvzkpRY/edit?usp=sharing&ouid=105479325952716032226&rtpof=true&sd=true
export class Person {
    private _id: number;
...
//             let choice = prompt("Hãy nhập vào lựa chọn của bạn: ");
//             switch(choice) {
//                 case "1":
//                     break;
//                 case "2":
