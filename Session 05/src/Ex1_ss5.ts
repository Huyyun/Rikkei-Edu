...
//                     let role = prompt("Nhập vai trò nhân viên: ");
//                     this.taskManager.addEmployee(empName!, role!);
//                     break;
//                 case "2":
//                     let mgrName = prompt("Nhập tên quản lý: ");
//                     let mgrRole = prompt("Nhập vai trò quản lý: ");
//                     let department = prompt("Nhập bộ phận: ");
//                     this.taskManager.addManager(mgrName!, mgrRole!, department!);
//                     break;
//                 case "3":
//                     let taskTitle = prompt("Nhập tiêu đề nhiệm vụ: ");
//                     let deadline = prompt("Nhập deadline nhiệm vụ (YYYY-MM-DD): ");
//                     this.taskManager.addTask(taskTitle!, deadline!);
//                     break;
//                 case "4":
//                     let empId = parseInt(prompt("Nhập ID nhân viên: ")!);
//                     let taskId = parseInt(prompt("Nhập ID nhiệm vụ: ")!);
//                     this.taskManager.assignTask(empId, taskId);
//                     break;
//                 case "5":
//                     let compTaskId = parseInt(prompt("Nhập ID nhiệm vụ đã hoàn thành: ")!);
