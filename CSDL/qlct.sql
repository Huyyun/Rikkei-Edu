...
INSERT INTO `architect` VALUES (1,'le thanh tung',1956,0,'tp hcm','25 duong 3/2 tp bien hoa'),(2,'le kim dung',1952,0,'ha noi','18/5 phan van tri tp can tho'),(3,'nguyen anh thu',1970,0,'new york','khu 2 dhct tp can tho'),(4,'nguyen song do quyen',1970,0,'ha noi','73 tran hung dao tp hcm'),(5,'truong minh thai',1950,0,'paris france','12/2/5 tran phu tp hanoi'),(6,'tran minh cuong',1985,0,NULL,'hanoi'),(7,'tran minh duong',1985,0,'ha nam','hanoi');
...
INSERT INTO `building` VALUES (1,'khach san quoc te','5 nguyen an ninh','can tho',450,'1994-12-13',1,1),(2,'cong vien thieu nhi','100 nguyen thai hoc	','can tho',200,'1994-05-08',2,1),(3,'hoi cho nong nghiep','bai cat','vinh long',1000,'1994-06-10',1,1),(4,'truong mg mang non','48 cm thang 8','can tho',30,'1994-07-10',3,3),(5,'khoa trong trot dhct','khu ii dhct	','can tho',3000,'1994-06-19',4,3),(6,'van phong bitis','25 phan dinh phung','ha noi',40,'1994-05-10',5,3),(7,'nha rieng 1','124/5 nguyen trai','tp hcm',65,'1994-11-15',6,2),(8,'nha rieng 2','76 chau van liem','ha noi',200,'1994-06-09',7,4),(9,'cong vien thu le','15 van cao','ha noi',4000,'1994-05-09',6,2),(10,'cong vien thong nhat','33 hoi vu','ha noi',3500,'1994-04-09',5,3),(11,'vincom ba trieu','30 ba trieu','ha noi',5000,'1994-04-09',6,NULL),(12,'vincom ocean park','29 hung yen','hung yen',5000,'1994-04-09',6,NULL);
...
INSERT INTO `contractor` VALUES (1,'cty xd so 6','567456','5 phan chu trinh'),(2,'phong dich vu so xd','206481','2 le van sy'),(3,'le van son','028374','12 tran nhan ton'),(4,'tran khai hoan','658432','20 nguyen thai hoc'),(5,'nguyen van luan','123423','30 le duan'),(6,'nguyen huu minh duong','543144','20 le ngoc han');
...
-- Dump completed on 2025-02-27 19:16:30
